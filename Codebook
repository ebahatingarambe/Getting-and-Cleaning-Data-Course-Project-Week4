...
FinalTidyDf was created by sumarizing FinalDf taking the means of each variable for each activity and each subject, after groupped by subject and activity.
